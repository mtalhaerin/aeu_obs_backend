...
using Business.DTOs.RequestDTOs.KullaniciDTOs;
...
namespace WebAPI.Controllers.Admin
{
    ...
    public class UserController : GenericController
    {
        ...
        [HttpGet("users")]
        [Authorize]
        [Tags("Kullanıcı: Genel")]
        public async Task<IActionResult> GetUsers([FromHeader(Name = "Authorization")] string token, [FromQuery] UsersQueryRequestDTO query, int page, int pageSize)
        {
