using Business.Features.CQRS._Generic.Response.FailResponse;
using Business.Features.CQRS._Generic.Response.SuccessResponse;
using System;
...
namespace Business.Features.CQRS._Generic.Response
{
    /// <summary>
    ...
    public class BaseResponse<T>
    {
        ...
        {
            if (data != null)
                return new SuccessResponseWithData<T>
                {
                    IsSuccess = true,
                    Data = data,
                    Message = message,
        ...
        public static BaseResponse<T> Failure(string message, List<string>? errors = null, int statusCode = 400)
        {
            ...
            {
                return new FailResponseWithErrors<T>
                {
                    IsSuccess = false,
                    Message = message,
                    Errors = errors,
